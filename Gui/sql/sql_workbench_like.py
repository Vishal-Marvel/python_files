...
def remove_all():
    ...
    # Add a little message box for fun
    messagebox.showinfo("Deleted!", "All Record Has Been Deleted!")
...
def select_record(e):
    ...
    remove_one_button.config(state='active')
    remove_many_button.config(state='active')
    move_down_button.config(state='active')
    move_up_button.config(state='active')
...
def add_record():
    ...
    try:
        ...
        c.execute("INSERT INTO customers VALUES (:first, :last, :id, :address, :city, :state, :zipcode)",
            {
                'first': fn_entry.get(),
                'last': ln_entry.get(),
                'id': id_entry.get() if id_entry.get() else None,
                'address': address_entry.get(),
                'city': city_entry.get(),
                'state': state_entry.get(),
                'zipcode': zipcode_entry.get(),
        ...
        messagebox.showerror('IntegrityError', 'Inegrity Error in column id')
...
update_button = Button(button_frame, text="Update Record", command=update_record, state='disabled')
...
remove_one_button = Button(button_frame, text="Remove One Selected", command=remove_one, state='disabled')
remove_one_button.grid(row=0, column=3, padx=10, pady=10)

remove_many_button = Button(button_frame, text="Remove Many Selected", command=remove_many, state='disabled')
remove_many_button.grid(row=0, column=4, padx=10, pady=10)

move_up_button = Button(button_frame, text="Move Up", command=up, state='disabled')
move_up_button.grid(row=0, column=5, padx=10, pady=10)

move_down_button = Button(button_frame, text="Move Down", command=down, state='disabled')
