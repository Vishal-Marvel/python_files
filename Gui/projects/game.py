...
class Ball:
    ...
    def draw(self):
        ...
        if pos[3] >= self.canvas_height:
            ...
            label = Label(tk, text="Game Over", font=25)
            label.place(relx=0.4, rely=0.4, relheight=0.3, relwidth=0.3)
...
tk = Tk()
tk.title('Game')
canvas = Canvas(tk, width=350, height=350, bd=0, highlightthickness=0)
canvas.pack()
tk.update()
